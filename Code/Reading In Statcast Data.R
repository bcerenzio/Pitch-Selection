...
#### Dates ####
(dates_2021 <- seq.Date(as.Date('2021-04-01'), as.Date('2021-11-03'), by = '4 days'))
(dates_2022 <- seq.Date(as.Date('2022-04-07'), as.Date('2022-11-05'), by = '4 days'))
(dates_2023 <- seq.Date(as.Date('2023-03-30'), as.Date('2023-11-01'), by = '4 days'))
(dates_2024 <- seq.Date(as.Date('2023-03-20'), as.Date('2023-10-30'), by = '4 days'))
...
get_statcast_data <- function(date){
  ...
  df <- statcast_search_batters(start_date, end_date)
  df %>% 
...
asfs <- map_df(dates_2021[1:3], get_statcast_data)
